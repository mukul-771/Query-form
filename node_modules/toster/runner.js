import { TestTree } from './tree';
import { Emitter } from './emitter';


export class Runner extends Emitter {
  constructor() {
    super();

    this._defaultTree = new TestTree();
    this._onlyTree = new TestTree();
  ...
  _run() {
    this.emit('start');
    let result = this._runOnly ?
      this._onlyTree.run() :
      this._defaultTree.run();
